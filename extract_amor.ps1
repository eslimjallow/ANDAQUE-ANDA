# Extract content from El amor no caduca.docx
$basePath = "C:\Users\eslim\ANDA QUE ANDA"
$docxPath = Join-Path $basePath "El amor no caduca.docx"
$tempPath = Join-Path $basePath "amor_temp.docx"
$outputPath = Join-Path $basePath "amor_content_order.txt"
...
try {
    ...
    $assetsPath = Join-Path $basePath "anda-que-anda-static\assets"
